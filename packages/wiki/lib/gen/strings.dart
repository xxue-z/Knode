...
mixin class L10nStringsMixin {
  ...
  String get wiki_category_panel =>
      LocalizeStringDelegate.get('wiki_category_panel');

  /// 类目树
  String get wiki_category_tree =>
      LocalizeStringDelegate.get('wiki_category_tree');

  /// 引用
  String get wiki_citation => LocalizeStringDelegate.get('wiki_citation');
  ...
  String get wiki_delete_document =>
      LocalizeStringDelegate.get('wiki_delete_document');
  ...
  String get wiki_graph_controller =>
      LocalizeStringDelegate.get('wiki_graph_controller');

  /// 图谱边
  String get wiki_graph_edge => LocalizeStringDelegate.get('wiki_graph_edge');
  ...
  /// 导入
  String get wiki_import => LocalizeStringDelegate.get('wiki_import');
  ...
  /// 摘要生成器
  String get wiki_summarizer => LocalizeStringDelegate.get('wiki_summarizer');
  ...
  /// 工作
  String get wiki_work => LocalizeStringDelegate.get('wiki_work');

  /// 放大
  String get wiki_zoom_in => LocalizeStringDelegate.get('wiki_zoom_in');
